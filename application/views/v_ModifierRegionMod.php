...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
        ...
        <body>
            ...
            <?php echo form_open('Ctrl_Visiteur/form_validerRegion');  ?>
            ...
            <br><input type="submit" class="btn btn-info" name="subValider" value="Modifier le visiteur" onclick="location.href='<?php echo base_url(); ?>index.php/Ctrl_Visiteur/modRegion/'">           
<?php echo form_close();  ?>
