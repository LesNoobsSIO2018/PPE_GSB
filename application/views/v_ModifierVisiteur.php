        ...
        <body>
           ...
           <table class="table">
               ...
               <tr>
                   ...
                   <td><input type="submit" class="btn btn-info" name="subValider" value="Choisir" onclick="location.href='<?php echo base_url(); ?>index.php/Ctrl_Visiteur/modifierVisiteurMod/'"<?php echo $vis->VIS_MATRICULE; ?>/>           
               </tr>
          <?php   
            }
           ?>  
